            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <h4
                        ...
                        Nursery</h4>
                    <h1 class="text-dark mb-4 display-5">Enhancing interaction, cultivating creativity and improving imagination through art and music.</h1>
                    <p class="text-dark mb-4">
                        The EuroKids Nursery Program places a strong emphasis on holistic development, with a core focus on imparting essential life skills to young learners. Through a carefully crafted curriculum, the program aims to enhance learning and foster meaningful interactions among children. It cultivates creativity and nurtures curiosity, providing opportunities for exploration and discovery. Moreover, the program stimulates imagination through engaging activities such as art and music, encouraging children to express themselves creatively and develop their unique talents.
                    </p>
                    <div class="row mb-4">
                         <div class="col-lg-6">
                            <h6 class="mb-3"><i class="fas fa-check-circle me-2"></i>3-4 years age</h6>
