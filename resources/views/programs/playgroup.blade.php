            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <h4
                        ...
                        PlayGroup</h4>
                    <h1 class="text-dark mb-4 display-5">Discovery and exploration, language development,
                        new-age skills, and shaping scientific mindset.</h1>
                    <p class="text-dark mb-4">
                        Our program focuses on emerging new skills and develop multidisciplinary learning at EuroKids. We
                        encourage developmental milestones and emerging interests in academics, creative expression and
                        outdoor learning.
                    </p>
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <h6 class="mb-3"><i class="fas fa-check-circle me-2"></i>2-3 years age</h6>
