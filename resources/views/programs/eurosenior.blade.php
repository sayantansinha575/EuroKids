            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <h4
                        ...
                        EuroSenior</h4>
                    <h1 class="text-dark mb-4 display-5">Developing vocabulary, attention span, reading and writing skills with innovative methods and preparing for primary school.</h1>
                    <p class="text-dark mb-4">
                        Preparing children for primary school involves several key aspects: building and enhancing vocabulary, developing attention span, introducing innovative methods for reading and writing improvement, and fostering a love for learning.
                    </p>
                    <div class="row mb-4">
                         <div class="col-lg-6">
                            <h6 class="mb-3"><i class="fas fa-check-circle me-2"></i>5-6 years age</h6>
